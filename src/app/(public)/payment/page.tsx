...
//           seatNumber: item.seatNumber,
//           price: item.price,
//           boardingStation: item.departureStation,
//           alightingStation: item.arrivalStation,
//           name: passengerInfo[index].fullName,
//           citizenId: passengerInfo[index].idNumber,
//           customerObject: mapPassengerTypeToCustomerObject(
//             passengerInfo[index].passengerType
//           ),
//         }))
//       );
...
//           boardingStation: cartItems[index].departureStation,
//           alightingStation: cartItems[index].arrivalStation,
...
//             ? "VNPay"
//             : selectedPaymentMethod,
//         trainTripId: parseInt(cartItems[0].trainId.split("-")[1]), // Extract trainTripId
//       };
...
//       const bookingBody: CreateBookingBodyType = {
//         trainTripId: cartItems[0].trainTripId,
//         contactEmail,
//         contactPhone: contactPhone || undefined,
...
//             console.log(">>>>>>> createBooking onSuccess response:", response);
//             if (response.payload.data?.data) {
//               console.log(">>>>>>> Retailway URL:", response.payload.data.data);
//               window.location.href = response.payload.data.data;
//             } else {
//               console.log(">>>>>>> No data in response:", response);
//               toast({
...
export default function Payment() {
  ...
  //   if (!bookingBody.tickets.every((t) => t.name && t.citizenId)) {
  //     toast({
  //       variant: "destructive",
  //       title: "Lỗi",
  //       description:
  //         "Thông tin hành khách không hợp lệ. Vui lòng kiểm tra lại.",
  //     });
  //     return;
  //   }
  ...
  //   });
  //   console.log(">>>>>>>>>>>>>> traintrip id", bookingBody.trainTripId);
  //   console.log(">>>>>>>>>>>>>> ticket param", ticketsParam);
  //   createBooking(
  //     {
  //       body: bookingBody,
  //       ticketsParam,
